...
def generate_launch_description():
    ...
    pkg_gripperbot_description_share = FindPackageShare('gripperbot_description')
    ...
    declare_urdf_model_cmd = DeclareLaunchArgument(
        'urdf_model',
        default_value=PathJoinSubstitution([pkg_gripperbot_description_share, 'urdf', 'gripperbot.urdf.xacro']),
        description='Absolute path to robot URDF file')
    
    # The rviz config file choice is passed down as an argument by top level launch files
    declare_rviz_config_file_cmd = DeclareLaunchArgument(
        'rviz_config_file',
        default_value=PathJoinSubstitution([pkg_gripperbot_description_share, 'rviz', 'display_only_config.rviz']),
